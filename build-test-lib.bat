...
cl -nologo -Gm- -Zi -FC -Tc "..\src\sha2.h" -DHASHUTIL_SHA2_IMPLEMENTATION -Fesha2.dll -Fmsha2.map /link -DLL -incremental:no -PDB:sha2.pbd -EXPORT:SHA2_GetVersion -EXPORT:SHA2_HashStringSHA256_224 -EXPORT:SHA2_HashStringSHA256_256 -EXPORT:SHA2_HashStringSHA512_384 -EXPORT:SHA2_HashStringSHA512_512 -EXPORT:SHA2_HashStringSHA512_224 -EXPORT:SHA2_HashStringSHA512_256
