...
IF [%DEBUG%] == [1] (
    :: Making debug build
    set CompilerFlags=-nologo -Od -Gm- -MT -GR- -EHa- -Oi -W4 -FC -DHASHUTIL_SLOW=1 -Zi -DEBUG:FULL
) ELSE (
    :: Making release build
    set CompilerFlags=-nologo -Od -Gm- -MT -GR- -EHa- -Oi -W4 -FC -DHASHUTIL_SLOW=0
)
...
:: Compile test runner
del *.pdb > NUL 2> NUL
cl %CompilerFlags% "..\src\hashutil.cpp" /link %LinkerFlags%
popd
